...
export class MatieresComponent implements OnInit {
  ...
  constructor(private router: LocationStrategy, private routerr: Router, private route: ActivatedRoute, private api: ApiService) {
    this.id = this.routerr.getCurrentNavigation()?.extras?.state?.ID;
  }
